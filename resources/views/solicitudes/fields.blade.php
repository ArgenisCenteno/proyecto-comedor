...
<div class="row">
    ...
    <div class="col-md-12 mt-12">
        ...
        {!! Form::select('proveedor', $proveedores->pluck('razon_social', 'id'), null, ['class' => 'form-control round select2']) !!}
    </div>
    ...
    <div class="col-md-12 mt-2">
        ...
        {!! Form::textarea('uso', null, ['class' => 'form-control', 'placeholder' => 'Uso del producto', 'rows' => 3]) !!}
    </div>
