...
<div class="col-md-12 mt-2 mb-2">
    ...
    {!! Form::select('status', [
        ...
        'aprobado' => 'Aprobado',
        'cancelado' => 'Cancelado'
    ], $solicitud->status, ['class' => 'form-control', 'placeholder' => 'Selecciona un estado']) !!}
</div>
    
    <div class="col-md-12 mt-12">
    <label for="status"><strong>Proveedor</strong></label>
        {!! Form::select('proveedor', $proveedores->pluck('razon_social', 'id'), $solicitud->proveedor_id, ['class' => 'form-control round select2']) !!}
    </div>

    <div class="col-md-12 mt-4">
        <label for=""><strong>Descripción del Producto</strong></label>
        {!! Form::textarea('descripcion', $solicitud->descripcion, ['class' => 'form-control', 'placeholder' => 'Descripción del producto', 'rows' => 3]) !!}
    </div>

    <div class="col-md-12 mt-2">
        <label for=""><strong>Uso del Producto</strong></label>
        {!! Form::textarea('uso', $solicitud->uso, ['class' => 'form-control', 'placeholder' => 'Uso del producto', 'rows' => 3]) !!}
    </div>
