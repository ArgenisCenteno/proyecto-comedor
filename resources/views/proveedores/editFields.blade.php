        ...
        <div class="row">
            <div class="col-md-3">
                {!! Form::select('prefijo', [
                    ...
                    '0426' => '0426',
                    '0424' => '0424'
                ], old('prefijo', substr($proveedor->telefono, 0, 4) ?? ''), ['class' => 'form-control round', 'required']) !!}
            </div>
            <div class="col-md-9">
                {!! Form::text('telefono', old('telefono', substr($proveedor->telefono, 4) ?? ''), ['class' => 'form-control round', 'required']) !!}
            </div>
        </div>
    </div>
