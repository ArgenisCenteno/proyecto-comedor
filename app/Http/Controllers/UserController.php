...
class UserController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($requerimientos)
                ->addColumn('actions', function($row) {
                    return '<a href="'.route('usuarios.edit', [$row->id]).'"><span class="material-icons">edit</span></a>
    ...
    public function store(Request $request)
    {
        ...
        $user = User::create([
            ...
            'password' => Hash::make($validatedData['password']), // Asegúrate de hashear la contraseñ
